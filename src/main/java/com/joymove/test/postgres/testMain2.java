    ...
    public  static void main(String[] args) {
        try {
            ...
            * */
            ...
            ResultSet rs = st.executeQuery("SELECT id,extendinfo,ST_AsText(location) as location,\"testArr\" FROM \"JOY_PowerBar\"");
            while(rs.next()) {
                //rs.get 是从1开始的
                /* 获取 id */
                ...
                /* 获取 location  */
                Object location  = (Object)rs.getObject("location");

                if(location!=null) {

                    System.out.println("location is " + location.toString());
                    System.out.println("location class is " + location.getClass());
                    System.out.println("***************************");
                    Geometry p = PGgeometry.geomFromString(location.toString());
                    System.out.println("geometry type is "+p.getType());
                } else {
